...
- `lib/flowchart/data.ts` — all quiz content lives here (questions, options, results, "not sure how to answer?" guidance, and each result's "Learn more" reading list and follow-the-author CTA). Editing or extending the quiz means editing this file only, no component changes needed.
